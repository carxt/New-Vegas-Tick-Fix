...
__declspec(naked) float __fastcall GetVectorLengthHook(NiVector3* inVect)
{
	__asm
	{
		movd    xmm0, [ecx]
...
void HookInlines()
{
	...
	//provided by jazzisparis, thanks jazz
	jazzsHooks();
	WriteRelJump(0x457990, (UInt32)GetVectorLengthHook);
}